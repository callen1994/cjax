...
export declare function useCurrentRoute<T extends RouteFig>(parentRoute: string[], routes: T[]): import("@cjax/cjax").Emitter<T | undefined> | undefined;
...
export declare function findRouteOrNavToDefault<R extends RouteFig>(url: URL, parentRoute: string[], routes: R[]): R | undefined;
